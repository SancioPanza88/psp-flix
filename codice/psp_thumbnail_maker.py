...
class ThumbnailMakerApp(tk.Tk):
    ...
    def create_thumbnail(self):
        ...
        try:
            ...
            img = img.resize(THM_SIZE, Image.Resampling.LANCZOS)
            # Baseline JPEG (mai progressivo): alcuni firmware PSP
            # rifiutano i JPEG progressivi come copertina.
            img.save(thm_path, "JPEG", quality=90, progressive=False, optimize=True)
