"""FilmyOnlineCc provider (ported from FilmyOnlineCcProvider.kt).
...
class FilmyOnlineCcProvider(Provider):
    base_url = "http://filmyonline.cc"
    name = "FilmyOnlineCc"
    language = "pl"
    ...
    movies_path = "{base}/filmy/page/{page}"
    tv_path = "{base}/seriale/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[FilmyOnlineCcProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[FilmyOnlineCcProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[FilmyOnlineCcProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[FilmyOnlineCcProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[FilmyOnlineCcProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[FilmyOnlineCcProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[FilmyOnlineCcProvider] servers error: {e}")
        return servers
