"""HDFilme provider (ported from HDFilmeProvider.kt).
...
class HDFilmeProvider(Provider):
    base_url = "https://hdfilme.win"
    name = "HDFilme"
    language = "de"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[HDFilmeProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[HDFilmeProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[HDFilmeProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[HDFilmeProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[HDFilmeProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[HDFilmeProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[HDFilmeProvider] servers error: {e}")
        return servers
