"""CB01 provider (ported from CB01Provider.kt).
...
class CB01Provider(Provider):
    base_url = "https://cb01official.uno"
    name = "CB01"
    language = "it"
    ...
    tv_path = "{base}/serietv/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[CB01Provider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[CB01Provider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[CB01Provider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[CB01Provider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[CB01Provider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[CB01Provider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[CB01Provider] servers error: {e}")
        return servers
