"""Einschalten provider (ported from EinschaltenProvider.kt).
...
class EinschaltenProvider(Provider):
    base_url = "https://einschalten.in"
    name = "Einschalten"
    language = "de"
    supports_movies = True
    supports_tv_shows = False

    search_path = "{base}/?s={q}"
    movies_path = "{base}/filme/page/{page}"
    tv_path = "{base}/filme/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[EinschaltenProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[EinschaltenProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[EinschaltenProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[EinschaltenProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[EinschaltenProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[EinschaltenProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[EinschaltenProvider] servers error: {e}")
        return servers
