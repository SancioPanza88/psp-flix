"""MEGAKino provider (ported from MEGAKinoProvider.kt).
...
class MEGAKinoProvider(Provider):
    base_url = "https://megakino7.com"
    name = "MEGAKino"
    language = "de"
    supports_movies = True
    supports_tv_shows = True

    search_path = "{base}/?do=search&subaction=search&story={q}"
    movies_path = "{base}/filme/page/{page}"
    tv_path = "{base}/serien/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[MEGAKinoProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[MEGAKinoProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[MEGAKinoProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[MEGAKinoProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[MEGAKinoProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[MEGAKinoProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[MEGAKinoProvider] servers error: {e}")
        return servers
