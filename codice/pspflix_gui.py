    ...
    def _process_item(self, item):
        ...
        try:
            ...
            if not stream_url:
                ...
                return
            # Nome file PSP-safe: la XMB mostra "Dati danneggiati" anche per
            # file validi se il nome ha spazi/accenti/caratteri speciali o è
            # troppo lungo. sanitize_psp_basename() lo riduce ad ASCII corto.
            safe_title = sanitize_psp_basename(item["title"])
