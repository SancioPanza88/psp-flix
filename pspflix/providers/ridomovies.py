"""Ridomovies provider (ported from RidomoviesProvider.kt).
...
class RidomoviesProvider(Provider):
    base_url = "https://ridomovies.tv"
    name = "Ridomovies"
    language = "it"
    ...
    movies_path = "{base}/movies/page/{page}"
    tv_path = "{base}/tv-series/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[RidomoviesProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[RidomoviesProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[RidomoviesProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[RidomoviesProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[RidomoviesProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[RidomoviesProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[RidomoviesProvider] servers error: {e}")
        return servers
