"""LaCartoons provider (ported from LaCartoonsProvider.kt).
...
class LaCartoonsProvider(Provider):
    ...
    search_path = "{base}/?utf8=%E2%9C%93&Titulo={q}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[LaCartoonsProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[LaCartoonsProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[LaCartoonsProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[LaCartoonsProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[LaCartoonsProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[LaCartoonsProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[LaCartoonsProvider] servers error: {e}")
        return servers
