"""Animefenix provider (ported from AnimefenixProvider.kt).
...
class AnimefenixProvider(Provider):
    ...
    search_path = "{base}/directorio/anime?q={q}&p={page}"
    movies_path = "{base}/directorio/anime?p={page}"
    tv_path = "{base}/directorio/anime?p={page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[AnimefenixProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[AnimefenixProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[AnimefenixProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[AnimefenixProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[AnimefenixProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[AnimefenixProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[AnimefenixProvider] servers error: {e}")
        return servers
