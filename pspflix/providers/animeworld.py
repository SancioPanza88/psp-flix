"""AnimeWorld provider (ported from AnimeWorldProvider.kt).
...
class AnimeWorldProvider(Provider):
    ...
    search_path = "{base}/search?keyword={q}"
    movies_path = "{base}/filter?language[]=0&page={page}"
    tv_path = "{base}/filter?page={page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[AnimeWorldProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[AnimeWorldProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[AnimeWorldProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[AnimeWorldProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[AnimeWorldProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[AnimeWorldProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[AnimeWorldProvider] servers error: {e}")
        return servers
