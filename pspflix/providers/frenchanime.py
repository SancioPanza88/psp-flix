"""FrenchAnime provider (ported from FrenchAnimeProvider.kt).
...
class FrenchAnimeProvider(Provider):
    ...
    search_path = "{base}/index.php?do=search&subaction=search&story={q}"
    movies_path = "{base}/films-anime/page/{page}"
    tv_path = "{base}/animes-vostfr/page/{page}"
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[FrenchAnimeProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[FrenchAnimeProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[FrenchAnimeProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[FrenchAnimeProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[FrenchAnimeProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[FrenchAnimeProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[FrenchAnimeProvider] servers error: {e}")
        return servers
