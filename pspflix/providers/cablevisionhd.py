"""CableVisionHD provider (ported from CableVisionHDProvider.kt).
...
class CableVisionHDProvider(Provider):
    ...
    def search(self, query, page=1):
        ...
        try:
            ...
            print(f"[CableVisionHDProvider] search error: {e}")
            return []
    ...
    def get_movies(self, page=1):
        ...
        try:
            ...
            print(f"[CableVisionHDProvider] get_movies error: {e}")
            return []
    ...
    def get_tv_shows(self, page=1):
        ...
        try:
            ...
            print(f"[CableVisionHDProvider] get_tv_shows error: {e}")
            return []
    ...
    def get_movie(self, item_id):
        try:
            ...
            print(f"[CableVisionHDProvider] get_movie error: {e}")
    ...
    def get_tv_show(self, item_id):
        try:
            ...
            print(f"[CableVisionHDProvider] get_tv_show error: {e}")
    ...
    def get_episodes_by_season(self, season_id):
        ...
        try:
            ...
            print(f"[CableVisionHDProvider] episodes error: {e}")
            eps = [Episode(id=f"{season_id}#e1", number=1, title="Episodio 1")]
        return eps
    ...
    def _collect_servers(self, item_id):
        ...
        try:
            ...
            print(f"[CableVisionHDProvider] servers error: {e}")
        return servers
